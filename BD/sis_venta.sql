...
CREATE TABLE `detallefactura` (
  `correlativo` bigint(20) NOT NULL PRIMARY KEY,
...
CREATE TABLE `detalle_temp` (
  `correlativo` int(11) NOT NULL PRIMARY KEY,
...
CREATE TABLE `factura` (
  `nofactura` int(11) NOT NULL PRIMARY KEY,
  `fecha` datetime NOT NULL DEFAULT current_timestamp(),
...
(3, 'Impresora', 1, '800.00', 0, 1),
(4, 'Gaseosa', 3, '1500.00', 5, 1);
...
CREATE TABLE `proveedor` (
  `codproveedor` int(11) NOT NULL PRIMARY KEY,
...
CREATE TABLE `rol` (
  `idrol` int(11) NOT NULL PRIMARY KEY,
